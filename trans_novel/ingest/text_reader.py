...
def read_text(path: str, source_lang: str, target_lang: str) -> Document:
    ...
    # 先按章节标题切块
    # has_heading 用于区分“真实标题”与首个标题前的无标题前言块。
    chapters_raw: list[tuple[str, int, list[str], bool]] = []
    ...
    for ci, (title, level, body_lines, has_heading) in enumerate(chapters_raw):
